        ...
        <div className="home">
            <div className="home__header">
                <div className="home__headerLeft">
                    <a
                        href="https://github.com/AlexandrosAlexiou"
                    ...
                    <a
                        href="https://github.com/giannisChouliaras"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        Chouliaras
                ...
                <div className="home__headerRight">
                    ...
                    <a
                        href="http://cs.uoi.gr/~pitoura/courses/ap/ap21/index.html"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        Course
